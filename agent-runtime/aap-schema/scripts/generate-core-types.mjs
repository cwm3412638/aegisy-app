...
function renderCppSource() {
  const out = [
    ...
    `const QJsonObject &coreSchema() { static const QJsonObject value = QJsonDocument::fromJson(QByteArrayLiteral(${JSON.stringify(JSON.stringify(cppSchema))})).object(); return value; }`,
