...
void AgentWorkbenchWindow::loadWorkbenchBundle()
{
    QString html = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\">"
        ...
        "<div class=\"timeline-item timeline-approval complete\"><div class=\"timeline-avatar\">✋</div><div class=\"timeline-content\"><strong>Approval Required</strong><p>Execute: <code>rm -rf dist/</code></p><div class=\"timeline-status\">Pending user decision</div></div></div>"
